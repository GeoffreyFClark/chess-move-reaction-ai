...
TEMPLATES: dict[str, list[str]] = {
    "great_tactic": ["Tactical shot.", "Nice tactics!", "Sharp move!"],
    "solid_improvement": [
        "Improving move.",
    ...
    "blunderish": ["Likely mistake.", "This looks questionable.", "Risky decision here."],
    "neutral": ["Balanced move.", "Reasonable choice.", "Steady play."],
    "mate_for": ["Checkmate.", "Game over - checkmate!", "Victory achieved!"],
    "mate_against": [
        "Mate threat against you.",
        "Danger - mate on the horizon.",
        "Critical defensive situation.",
    ],
    "stalemate": ["Stalemate.", "No legal moves - game drawn.", "Draw by stalemate."],
    "insufficient_material": [
        "Draw by insufficient material.",
        "Neither side can force checkmate.",
        "The game is drawn - not enough pieces remain.",
    ],
    "game_continues": ["Game continues.", "Play on.", "The position remains dynamic."],
}
